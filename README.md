...
In this case wait and retry, or implement caching (planned).
...
6. **Improved logging**
   ...
   - Support `LOG_LEVEL=INFO|DEBUG`.

7. **Prevent oversized LLM prompts automatically**
...
8. **Add technical indicators for price analysis**
   - SMA/EMA (20/50/200)
   - RSI (14)
   - MACD
...
9. **Add trend classification**
   - Define rules like:
     - “Bullish / bearish / sideways”
     - based on moving averages + momentum + volatility.

10. **Improve news signal extraction**
...
11. **News source ranking system**
   - Score domains by trust level (Reuters > random blog).
   - Prefer multi-source confirmation.
   - Drop low-quality sources automatically.

12. **Deduplication and clustering of news**
   - Detect repeated articles / same narrative from different sources.
   - Cluster by topics: ETF / regulation / macro / hacks / miners, etc.
